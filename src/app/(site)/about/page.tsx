...
export const metadata: Metadata = {
  title: "Our Story",
  description:
    "Umthombo means a spring - a source of renewal and flow. The story behind our handcrafted candles and skincare - made in Cape Town, delivered across South Africa - and our commitment to eco-conscious craft.",
