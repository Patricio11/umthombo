...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Talk to Umthombo Creations - WhatsApp, Instagram, Facebook, and collection in Woodstock, Cape Town. Nationwide delivery available.",
  alternates: { canonical: "/contact" },
  openGraph: {
    title: "Contact · Umthombo Creations",
    description:
      "WhatsApp us, find us on social, or collect in Woodstock, Cape Town. Nationwide delivery available.",
    url: "/contact",
  },
};
