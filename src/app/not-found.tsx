...
export default function NotFound() {
  return (
    <section className="flex min-h-[70dvh] flex-col items-center justify-center px-6 py-32 text-center">
      ...
      <p className="eyebrow mt-8 text-olive">Page 404</p>
      ...
      <div className="mt-9 flex flex-wrap items-center justify-center gap-4">
        <Link
          href="/"
          className="inline-flex items-center justify-center rounded-full bg-olive px-8 py-4 text-base font-medium text-cream transition-transform duration-300 hover:scale-[1.03] active:scale-[0.98]"
        >
          Back home
        </Link>
